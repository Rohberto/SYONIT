...
<div className="game_blank_screen"></div>
      ...
      <div className='game_main_buttons'>
         <div className='game-button-container'>
    <div className='gamebuttonsContainer'>
      <button className='onboarding_button onboarding_link_login onboarding_left game_single_button' onClick={() => {handleYesClick(); clickSoundRef.current.play()}} disabled={allRoundsPlayed}>Yes</button>
      <button className=' onboarding_button onboarding_link_sign onboarding_right game_single_button' onClick={() => {handleNoClick(); clickSoundRef.current.play();}} disabled={allRoundsPlayed}>No</button>
